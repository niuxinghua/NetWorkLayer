...
- (void)getData:(BOOL)isOn url:(NSString *)url
{
    ...
    if(isOn)
    {
        ...
        [NXHNetworkHelper GET:url parameters:nil responseCache:^(id responseCache) {
    ...
    else
    {
        ...
        [NXHNetworkHelper GET:url parameters:nil success:^(id responseObject) {
...
- (IBAction)download:(UIButton *)sender {
    ...
    if(!self.isDownload)
    {
        ...
        task = [NXHNetworkHelper downloadWithURL:downloadUrl fileDir:@"Download" progress:^(NSProgress *progress) {
